...
import style from './OrderSummeryStyle';
import {showMessage} from 'react-native-flash-message';

const {width, height} = Dimensions.get('window');
var totalPrice = 0;
var installPrice = 0;
export default function OrderSummery({navigation}) {
  ...
  console.log('cartDataOrderSumary', cartData);
          ...
          <View
            ...
            <View
              ...
              <View
                ...
                <Text style={{color: '#363636', fontSize: moderateScale(18)}}>
                ...
                ListEmptyComponent={() => (
                  <View
                    ...
                    <Text
                      ...
                      لا توجد عناوين شحن فى الوقت الحالى
                    </Text>
                  </View>
                )}
              />
