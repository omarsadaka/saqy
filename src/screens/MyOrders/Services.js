...
export default function Services({navigation}) {
  ...
  const {allServicesLoading, allServices, allStatus} = useSelector(
    state => state.orders,
  );
    ...
    <TouchableOpacity
      ...
      <View
        ...
        <View
          ...
          {/* <Text style={{ textAlign: 'right', textAlignVertical: 'center', width: '95%', fontSize: moderateScale(14), color: '#000000' }}>{item.total} {'رس'}</Text> */}
          <Text
            style={{
              textAlign: 'right',
              textAlignVertical: 'center',
    ...
    <View style={{width: '100%', height: '100%', alignItems: 'center'}}>
      <View
        ...
        <View
            ...
            <View
              ...
              <ModalDropdown
                ...
                onSelect={(index, value) => {
                  if (value.value == -1)
                    dispatch(getAllServiceAction(value.value));
                  else dispatch(getFilterServiceAction(value.value));
                }}
              />
            </View>
          ) : // <CustomPicker
          ...
          //     if (value == -1) dispatch(getAllServiceAction(value));
          //     else dispatch(getFilterServiceAction(value));
          //   }}
        ...
        <View
          ...
          <FlatList
            ...
            contentContainerStyle={[
              {flexGrow: 1},
              allServices ? null : {justifyContent: 'center'},
            ]}
            ListEmptyComponent={() => (
              <View
                style={{
            ...
            refreshControl={
              <RefreshControl
                colors={['blue', 'gray']}
                refreshing={allServicesLoading}
                onRefresh={() => dispatch(getAllServiceAction())}
              />
            }
          />
        </View>
